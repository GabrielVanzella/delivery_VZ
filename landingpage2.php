                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="section-heading text-center">
                            <h2 class="font-700 color-base text-uppercase wow fadeInUp" data-wow-delay="0.1s">Sobre o Disk Pedidos</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="about-content">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Disk Pedidos chegou revolucionando a forma de realizar pedidos via whatsapp, uma plataforma leve, simples para o seu cliente e complexa para o seu estabelecimento. </p>
                        ...
                        <div class="why-choose-content">
                            ...
                            <div class="why-choose-single fix wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="why-choose-single-details float-right">
                                    ...
                                    <p>Com o Disk Pedidos você consegue aumentar seu faturamento, otimizando tempo no recebimento do seu pedido.</p>
                                </div>
                            </div>
                            <!--End Why Choose Item-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="video-content text-center">
                            ...
                            <p class="color-white wow fadeInUp" data-wow-delay="0.2s">Assista ao vídeo e veja como é simples e fácil ter o Disk Pedidos em seu estabelecimento.</p>
                            <div class="video-popup-icon position-relative">
                                <div class="pulse1"></div>
                                <div class="pulse2"></div>
                                <a class="popup-video" href="<?=(!empty($texto['linkVideosLanding']) ? $texto['linkVideosLanding'] : "");?>"><i class="icofont icofont-play-alt-2"></i></a>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="section-heading text-center">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Confira abaixo os valores de nossos planos, teste grátis por durante <?=$texto['DiasDeTeste'];?> Dias.</p>
                        </div>
                    </div>
                    <!--End Heading Content-->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="pricing-table-single text-center wow fadeIn" data-wow-delay="0.1s">
                            ...
                            <div class="price-amount">
                                <h2 class="font-700 color-base2"><span><?=$texto['DiasDeTeste'];?> Dias para Teste</span></h2>
                            </div>
                            <div class="pricing-details">
                                <ul>
                                    ...
                                    <li class="font-500">Grátis <?=$texto['DiasDeTeste'];?> Dias</li>
                                </ul>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="pricing-table-single text-center wow fadeIn" data-wow-delay="0.2s">
                            ...
                            <div class="price-amount">
                                <h2 class="font-700 color-base2"><span>R$</span> <?=$texto['valorPlanoUm'];?> <sup class="font-800">.00</sup> <sub class="font-600"></sub></h2>
                            </div>
                            <div class="pricing-details">
                                <ul>
                                    <li class="font-500 ">Clientes Ilimitados</li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="pricing-table-single text-center wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <div class="price-amount">
                                <h2 class="font-700 color-base2"><span>R$</span> <?=$texto['valorPlanoDois'];?> <sup>.00</sup> <sub></sub></h2>
                            </div>
                            <div class="pricing-details">
                                <ul>
                                    <li class="font-500 ">Clientes Ilimitados</li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="pricing-table-single text-center wow fadeIn" data-wow-delay="0.4s">
                            ...
                            <div class="price-amount">
                                <h2 class="font-700 color-base2"><span>R$</span> <?=$texto['valorPlanoTres'];?> <sup>.00</sup> <sub></sub></h2>
                            </div>
                            <div class="pricing-details">
                                <ul>
                                    <li class="font-500 ">Clientes Ilimitados</li>
                        ...
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-default wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <div id="collapse3" class="panel-collapse collapse">
                                    <div class="font-500 panel-body">Não, todo o pagamento é feito na entrega ou na retirada diretamente para o estabelecimento, o Disk Pedidos não tem contato algum com o dinheiro recebido.</div>
                                </div>
                            </div>
                            <!--End Accordian Single-->
                            ...
                            <div class="panel panel-default wow fadeInUp" data-wow-delay="0.5s">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="font-600 accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse5">O Disk Pedidos tem fidelidade ?</a>
                                    </h4>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                        <div class="section-heading text-center">
                            ...
                            <p class="color-white wow fadeInUp" data-wow-delay="0.2s">Confira abaixo alguns testemunhos de clientes após conhecerem e usarem o Disk Pedidos em seu estabelecimento.</p>
                        </div>
                    </div>
                    <!--End Heading Content-->
                </div>
                            ...
                            <div class="testimonial-single row">
                                ...
                                <div class="col-sm-8">
                                    <div class="client-comment">
                                        <p class="wow fadeInUp" data-wow-delay="0.1s">O Disk Pedidos nos ajudou bastante, nossos clientes agora não precisam ficar pedindo cardápio, escolhendo ou perguntando. Muito prátio, ágil e fácil de utiliar, recomendo o Disk Pedidos a todos.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="contact-info-single text-center wow fadeIn" data-wow-delay="0.1s">
                                ...
                                <p><a href="mailto:<?=$texto['emailSuporteSite'];?>" ><?=$texto['emailSuporteSite'];?></a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="contact-info-single text-center wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <p><a href="tel:<?=$texto['telefoneAdministracaoVendas'];?>" ><?=$texto['telefoneAdministracaoVendas'];?></a></p>
                            </div>
                        </div>
                        <!--End Contact Info Single-->
                        ...
                        <div class="col-sm-3">
                            <div class="contact-info-single text-center wow fadeIn" data-wow-delay="0.3s">
                                ...
                                <p>seu endereço aqui depois</p></p>
                            </div>
                        </div>
                        <!--End Contact Info Single-->
                        ...
                        <div class="col-sm-3">
                            <div class="contact-info-single text-center wow fadeIn" data-wow-delay="0.4s">
                                ...
                                <p><a target="_blank" href="<?=(!empty($texto['link_do_insta']) ? $texto['link_do_insta'] : "");?>">Acessar Instagram</a></p>
                            </div>
                        </div>
                        <!--End Contact Info Single-->
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="footer-social text-left wow fadeIn" data-wow-delay="0.1s">
                            <ul>
                                <li><a href="<?=(!empty($texto['link_do_face']) ? $texto['link_do_face'] : "");?>"><i class="icofont icofont-social-facebook"></i></a></li>
                                <li><a href="<?=(!empty($texto['link_do_insta']) ? $texto['link_do_insta'] : "");?>"><i class="icofont icofont-social-instagram"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <!--End Footer Social-->
                    ...
                    <div class="col-sm-8">
                        <div class="copyright-text text-right wow fadeIn" data-wow-delay="0.2s">
                            <p class="color-white">&copy; 2021 Todos os direitos reservados <a class="color-base" href="#"><?=$texto['nome_site_landing'];?></a></p>
                        </div>
                    </div>
                    <!--End Copyright Text-->
                </div>
