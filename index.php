...
if(empty($Url[0]) || $Url[0] == 'index'):
	...
	<head>
		...
		<!-- Favicons-->
		<link rel="apple-touch-icon" type="image/png" href="<?=(!empty($img_logo) ? $site.'uploads/'.$img_logo : '')?>">
        ...
        <!--plugins-->		
        <script src="plugins/btnios/homescreen.js"></script>
        <link rel="stylesheet" type="text/css" href="plugins/btnios/homescreen.css">
		...
		<img  src="//sstatic1.histats.com/0.gif?4572928&101" alt="light-theme">
			...
			<nav class="col--md-8 col-sm-8 col-xs-8">
				...
				<div class="main-menu">
					...
					<ul>
						...
						<li><a href="<?=$site.$Url[0].'/';?>AAAAAAAA"><?=$texto['contato'];?></a></li>						
	...
	if(diasDatas(date('Y-m-d'), $empresa_data_renovacao) < 0 && !empty($_SESSION['userlogin']) && $_SESSION['userlogin']['user_id'] == $getu):
		?>
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
				...
				<a class="btn btn-warning" target="_blank" href="https://api.whatsapp.com/send?phone=55<?=$texto['telefoneAdministracaoVendas'];?>&amp;text=Solicito%20o%20boleto%20banc%C3%A1rio%20para%20pagamento.%0A%0A*Loja:*%20<?=$nome_empresa;?>%0A" rel="external nofollow">Solicitar Outra Forma de Pagamento</a>
			</form>
		</div>
...
?>
<script src="plugins/btnios/addtohomescreen.js"></script>
</body>
</html>
<?php
