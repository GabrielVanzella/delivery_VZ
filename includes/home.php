...
<div class="row">	
	<div class="col-md-3">	
		...
		<div class="box_style_1 hidden-xs">
			<ul id="cat_nav">
				<?php
				$lerbanco->ExeRead('ws_cat', "WHERE user_id = :userid ORDER BY posicaocat ASC", "userid={$getu}");
...
<div class="col-md-6" <?=($detect->isMobile() ? "style=\"padding-left: 2px;padding-right: 2px;\"" : "");?>>
	...
	<div class="box_style_2" id="main_menu">
		...
		<?php
		$lerbanco->ExeRead('ws_cat', "WHERE user_id = :useridd ORDER BY posicaocat ASC", "useridd={$getu}");
		if (!$lerbanco->getResult()):
